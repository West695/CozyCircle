...
<head>
    ...
    <title><?php echo $__env->yieldContent('title', 'CozyCircle'); ?></title>
...
<body class="bg-jive-purple min-h-screen relative font-sans flex flex-col">
    ...
    <div class="flex-1 flex flex-col">
        ...
        <?php if (! (request()->routeIs('login','signup','register'))): ?>
        ...
        <div class="relative bg-white w-full max-w-3xl rounded-2xl shadow-xl z-10 overflow-hidden">
            <div class="p-6">
                ...
                <div class="mt-4" id="postModalCommentFormContainer">
                    ...
                    <?php else: ?>
                    <div class="text-sm text-gray-600">Please <a href="<?php echo e(route('login')); ?>" class="underline">sign in</a> to comment.</div>
                    <?php endif; ?>
                </div>
            </div>
        </div>
...
</html><?php /**PATH C:\Vscode\WebProg AOL\CozyCircle2\CozyCircle\resources\views/layouts/app.blade.php ENDPATH**/ ?>